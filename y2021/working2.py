...
file_name = r'C:\Users\choll\PycharmProjects\MommyAI\testset\JensonBeach\image(14).png'
file_name = r'C:\Users\choll\PycharmProjects\MommyAI\out.png'
...
_, imagecv = cv2.threshold(imagecv, 245, 255, cv2.THRESH_BINARY)
...
cfg.autoconfigure(
    [(19, 19), (20, 20), (18, 18), (18, 19), (19, 20), (19, 18), (17, 17), (17, 18), (18, 17), (17, 19), (19, 17), (21,21), (20,21), (21,20)])
...
cfg1.width_range = (14, 25)
cfg1.height_range = (14, 26)
cfg1.scaling_factors = [10]
...
for i in rects1:
    ...
    d = 0
    for x in rectscopy:
        # Might want to change stuff
        # @TODO
        if abs(i[0] - x[0]) > 6 or abs(i[1] - x[1]) > 6:
            c += 1
        else:
            print("Was I to close to X?", i, x)
        d += 1
        if c >= d:
            rectscopy.append(i)
            print("Appended coordinate!")
            print(i)
            appendedcords += 1
...
print("RIGHT HERE")
imagecvcopy = imagecv
imagecvcopy = cv2.cvtColor(imagecvcopy, cv2.COLOR_GRAY2BGR)
newimage = rectntext(topleft, topright, bottomleft, bottomright, imagecvcopy)
