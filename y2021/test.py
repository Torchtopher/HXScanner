...
parser.add_argument('--od', '--outputDirectory', help='The place to output the list of files, outputs to current directory if left blank')
...
def hxsheet(file_name):
    ...
    cfg.autoconfigure([(19,19),(20,20),(18,18),(18,19),(19,20),(19,18),(17,17),(17,18),(18,17),(17,19),(19,17)])
    ...
    cfg1.width_range = (15,25)
    cfg1.height_range = (15,26)
    ...
    for i in rects1:
        ...
        for x in rectscopy:
            ...
            #@TODO
            if abs(i[0] - x[0]) > 6 and abs(i[1] - x[0]) > 6:
                c += 1
            d += 1
            if c >= d:
                rectscopy.append(i)
...
file_name = r'C:\Users\choll\PycharmProjects\MommyAI\Images\HXSheets\hxsheet1.png'
