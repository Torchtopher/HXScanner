...
def hxsheet(file_name):
    ...
    pages = convert_from_path('dexample.pdf', 150)
    ...
    print(oldcwd)
    os.chdir(pngimgs)
    print(f"{os.getcwd()} is current dir")
    char = "\\"
    initalfilename = initalfilename[initalfilename.rindex(char):]
    initalfilename = initalfilename[1:]
    if hascancer == False and hassurgury == False:
        pngwritename = "USABLE" + initalfilename + ".png"
    elif hascancer == True and hassurgury == False:
        pngwritename = "CANCER" + initalfilename + ".png"
    elif hascancer == False and hassurgury == True:
        pngwritename = "SURGERY" + initalfilename + ".png"
    elif hascancer == True and hassurgury == True:
        pngwritename = "SURGERYCANCER" + initalfilename + ".png"
    elif cancer > 1 or surgery > 1:
        pngwritename = "PROBLEM" + initalfilename + ".png"
    else:
        pngwritename = "ERROR" + initalfilename + ".png"
    print(pngwritename)

    cv2.imwrite(pngwritename, originalimg)
    os.chdir(oldcwd)
...
pngimgs = os.path.join(os.getcwd(), "DicomPNGS")
try:
    os.mkdir(pngimgs)
except:
    pass
...
#print("Folder", folder)
with open("HXout.csv", "r") as results:
